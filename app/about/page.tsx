      ...
      <div className="page-content">
        <div className="grid-layout-2">
          ...
          >
            ...
            <h3 className="text-xl mb-4 font-mono font-bold">Computer Science Student & Tech Enthusiast</h3>
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-mono font-bold">Project Mentor</h3>
              ...
              <div>
                <h3 className="text-xl font-mono font-bold">Technical Intern</h3>
                <p className="text-sm text-red-500 mb-2">
